...
export function StudentSidebar({
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-64 flex-col justify-between border-r border-sky-100 bg-white shadow-sm">
      {/* 상단: 로고 + 유저 정보 */}
      <div>
        <div className="flex flex-col items-center gap-2 border-b border-sky-100 px-5 py-5">
          ...
          <p className="text-base font-bold text-slate-700 leading-tight text-center">
            안전 포트폴리오
          </p>
        </div>
        ...
        <div className="mx-4 mt-4 rounded-xl bg-gradient-to-br from-sky-50 to-blue-50 border border-sky-200 p-3 text-center">
          <p className="text-base font-bold text-slate-700 truncate">{userName}</p>
