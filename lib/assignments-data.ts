/** 7대 안전 영역별 과제 (교육부·학교 안전교육 흔한 분류에 맞춤) */
...
export const ASSIGNMENTS: Assignment[] = [
  ...
  {
    id: "assign-2",
    title: "화재 대피·소화기 위치 인증",
    description:
      "화재 대피 훈련을 떠올리며 대피 경로를 확인하고, 교실·복도의 소화기·비상구 위치를 찍어 인증해 주세요. 느낀 점을 설명란에 적어도 좋아요.",
    category: "화재안전",
    emoji: "🧯",
    dueDate: "2026-06-12",
    points: 12,
  ...
  },
  {
    ...
    description:
      "심폐소생술 순서를 말으로 설명하거나 인형·쿠션으로 가슴 압박 연습하는 모습을 인증해 주세요. 보건·안전 영상을 참고해도 좋아요.",
    category: "응급처치",
    emoji: "🏥",
    dueDate: "2026-06-18",
    points: 18,
  ...
  {
    id: "assign-5",
    title: "사이버 폭력 예방 서약·실천",
    description:
      "온라인에서 함부로 말하지 않기, 개인정보 보호하기 등 실천 다짐을 손글씨로 쓰거나 그림으로 표현해 인증샷을 올려주세요.",
    category: "사이버예방",
    emoji: "💬",
    dueDate: "2026-06-22",
    points: 12,
